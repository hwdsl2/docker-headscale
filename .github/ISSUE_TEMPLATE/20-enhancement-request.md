...
- [ ] I searched existing [Issues](https://github.com/hwdsl2/docker-headscale/issues?q=is%3Aissue), and did not find a similar enhancement request
- [ ] I read the [README](https://github.com/hwdsl2/docker-headscale/blob/main/README.md) or the relevant section
- [ ] This request is about the Headscale Docker image/config
...
- [ ] Client configuration or management helper
- [ ] Networking, ports, firewall or IPv6
- [ ] Documentation
